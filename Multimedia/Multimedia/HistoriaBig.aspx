<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HistoriaBig.aspx.vb" Inherits="Multimedia.HistoriaBig" %>
...
<body style="width: 1064px; height: 1001px">
    <form id="FrmBigData2" runat="server" class="auto-style6" style="width: 1050px; height: 1000px; background-color: #99CCFF;">
            ...
            <asp:Panel ID="Panel1" runat="server" BorderColor="#CCFFCC" BorderStyle="Outset" Height="648px">
                <div class="auto-style28" style="font-family: Tahoma; font-style: oblique; color: #000066; font-weight: bold; text-transform: none; font-variant: inherit; font-size: 50px; white-space: normal;">
                    ...
                    <table class="auto-style38">
                        <tr>
                            <td>
                                <iframe width="600" height="400" src="https://youtu.be/w4vsFKMO7XA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowfullscreen"></iframe>
                            </td>
                        </tr>
                    </table>
                        <br />
