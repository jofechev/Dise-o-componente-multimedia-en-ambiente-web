<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmMenuAsp.aspx.vb" Inherits="Multimedia.FrmMenuAsp" %>
                ...
                <table class="auto-style38">
                    <tr>
                        <td class="auto-style58">
                            <asp:Button ID="BtnTema1" runat="server" BackColor="#0066FF" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="53px" Text="Historia y Evolución" Width="420px" />
                        </td>
                    ...
                    <tr>
                        <td class="auto-style59">
                            <asp:Button ID="BtnTema2" runat="server" BackColor="#0066FF" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="53px" Text="Caracteristicas" Width="420px" />
                        </td>
                        <td class="auto-style40"></td>
                    </tr>
                    <tr>
                        <td class="auto-style58">
                            <asp:Button ID="BtnTema3" runat="server" BackColor="#0066FF" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="53px" Text="Extensiones" Width="420px" />
                        </td>
                        <td class="auto-style62"></td>
                    </tr>
                    <tr>
                        <td class="auto-style60">
                            <asp:Button ID="BtnTema4" runat="server" BackColor="#0066FF" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="53px" Text="Modelos de programación ASP.Net" Width="420px" />
                        </td>
                        <td class="auto-style43"></td>
                    </tr>
                    <tr>
                        <td class="auto-style61">
                            <asp:Button ID="BtnEvaluacion" runat="server" BackColor="Red" Font-Bold="True" Font-Italic="True" Font-Size="X-Large" ForeColor="White" Height="53px" Text="Evaluación" Width="420px" />
                        </td>
